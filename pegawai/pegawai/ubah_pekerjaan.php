                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h5 class="m-0">Form Edit Pekerjaan</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <!-- left column -->
                                    ...
                                    <form role="form" action="proses_ubah_pekerjaan.php" method="POST" enctype="multipart/form-data">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" value="<?php echo $dt['file_sk'] ?>" class="form-control" name="file_sk_lama">
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="profil.php?id=<?php echo str_replace(" ", "", $dt['nip']) ?>&tab=pekerjaan"><button type="button" class="btn btn-danger"> <i class="fa fa-reply"></i> Cancel</button></a>
