                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered  table-striped">
                            ...
                            <tbody>
                                ...
                                $sql = mysqli_query($koneksi, "SELECT pegawai.nip,pegawai.nama_pegawai,jabatan.jabatan from jabatan join pegawai on jabatan.id_jabatan=pegawai.id_jabatan where pegawai.nip='".$_SESSION['nip']."' ORDER BY pegawai.nama_pegawai ASC") or die(mysqli_error($koneksi));
