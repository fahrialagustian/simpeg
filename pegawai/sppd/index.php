                    ...
                    <div class="card-body ">
                        <table id="example1" class="table table-bordered   table-striped">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                $sql = mysqli_query($koneksi, "SELECT pegawai.nip,pegawai.nama_pegawai,sppd.maksud,sppd.id_sppd,sppd.status FROM pegawai JOIN sppd on pegawai.nip=sppd.nip where pegawai.nip='" . $_SESSION['nip'] . "' ORDER BY sppd.tgl_buat DESC") or die(mysqli_error($koneksi));
