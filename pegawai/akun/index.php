                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered  table-striped">
                            ...
                            <tbody>
                                ...
                                $sql = mysqli_query($koneksi, "SELECT akun.id_akun,pegawai.nip,pegawai.nama_pegawai,akun.username,akun.password,akun.status FROM akun JOIN pegawai on akun.id_akun=pegawai.id_akun  where pegawai.nip='" . $_SESSION['nip'] . "' ORDER BY pegawai.nama_pegawai ASC") or die(mysqli_error($koneksi));
